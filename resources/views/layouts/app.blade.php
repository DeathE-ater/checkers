...
<head>
    ...
    <script src="https://kit.fontawesome.com/289f866a31.js" crossorigin="anonymous" defer></script>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md w3-top navbar-light bg-white shadow-sm" style="position: fixed !important;">
            <div class="container">
                <button class="w3-bar-item w3-button w3-hide-large w3-hover-none w3-hover-text-light-grey" onclick="w3_open();"><i class="fa fa-bars"></i>  Menu</button>
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'MySen') }}
                </a>
