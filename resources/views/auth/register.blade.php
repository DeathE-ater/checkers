...
@section('content')
    ...
    <div id="container">
        <div class="row" >
            ...
            <div class="left col-md-3 signup-left" style="background: white; margin-top: 70px;">
            ...
            <div class="right signup-right col-md-3" style="background: url('images/signup-background.jpeg'); background-size: cover; background-position: center; margin-top: 70px;">
